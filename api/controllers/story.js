...
export const getStories = (req, res) => {
  ...
  jwt.verify(token, "secretkey", (err, userInfo) => {
    ...
    console.log(userInfo.id); // Corrected to userInfo.id
...
export const addStory = (req, res) => {
  ...
  jwt.verify(token, "secretkey", (err, userInfo) => {
    ...
    const values = [[req.body.img, moment(Date.now()).format("YYYY-MM-DD HH:mm:ss"), userInfo.id]]; // Corrected values format
